...
#gpt3_completion("jours de la semaine")
# gpt3_completion("site moi les titres du groupe anglais Madness fdp")

text = 'nous sommes en 1700'

def ask_question_to_pdf(prompt, text= text):
    response = gpt3_completion(prompt+'\n en utilisant eventuellement le texte suivant: \n' + text2)#it is a string
    return response
